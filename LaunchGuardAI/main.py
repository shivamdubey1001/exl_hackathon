...
def _ingest(df: pd.DataFrame, name: str) -> dict:
    ...
    detected = MAP.detect_mapping(df)
    meta = {
...
def suggest_k(did: str):
    """Silhouette per k so the user picks with evidence rather than a guess."""
    m = read_meta(did)
